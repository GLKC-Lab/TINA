...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.20541754.svg)](https://doi.org/10.5281/zenodo.20541754)
...
- [User Guide](docs/user-guide.md) — step-by-step instructions for both workflows, parameter guidance, troubleshooting, and output file descriptions
- [Download User Guide (.docx)](docs/TINA_UserGuide.docx) — formatted Word version
